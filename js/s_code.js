...
/* 원본 s_code.js에 추가함 */
var debugging = false;
function debug(s){try{if(debugging && console){console.log(s);}}catch(e){}}

//배열형식 [호스트(도메인),루트폴더,리포트ID,사이트명,메인페이지경로]
//호스트의 'www'는 제거, 동일호스트 등록시 상단에 위치한 호스트와 루트폴더를 먼저 인식

var arrInfo = [
       ['beautyangel-kr','btnsdev.amorepacific.com:8510','/front/webview/*','ap-beautyangel-dev '], //뷰티엔젤 개발
       ['beautyangel-kr','beautyangel.amorepacific.com','/front/webview/*','ap-beautyangel-prd'] //뷰티엔젤 운영
  ];




var curHost = window.location.host.replace('www.', '');
var curPath = window.location.pathname;
var curHostIdx = 0;

for (var i = 0; i < arrInfo.length; i++){
	var tempArrHost = ';' + arrInfo[i][1] + ';';
	var tempCurHost = ';' + curHost + ';';
	if (tempArrHost.indexOf(tempCurHost) >= 0 && curPath.indexOf(arrInfo[i][2].replace('*','')) == 0){
		curHostIdx = i;
		break;
	}
}
...
function getAccount(){
	return arrInfo[curHostIdx][3];
}

function getSiteName(){
	return arrInfo[curHostIdx][0];
}


//var s_sitename="heraimc-kr";
...
/*
	어도비에서 제공하는 trackClicks의 확장판.
	내부클릭수 : 'event5'가 기본값이며 입력시 해당값으로 할당
	페이지명포함여부 : false가 기본값이며 입력시 해당값으로 할당
	
	사용예
	trackClicksEx(내부클릭명);
	trackClicksEx(내부클릭명,내부클릭수);
	trackClicksEx(내부클릭명,페이지명포함여부);
	trackClicksEx(내부클릭명,내부클릭수,페이지명포함여부);
*/
function trackClicksEx() {
	try{
		...
		if (debugging) alert('ClickName : ' + ClickName + '\nClickevents : ' + Clickevents + '\nWithPageName : ' + WithPageName);
 
		trackClicks(ClickName,Clickevents);
...
//온라인 구입처 클릭
function trackClicksOnlineShop(ShopName, WithPageName) {
	s.linkTrackVars = 'eVar10,events';
	s.linkTrackEvents = 'event10';

	if (WithPageName == true)
		ShopName = s.pageName + '^' + ShopName;
	else
		ShopName = getSiteName() + '^' + ShopName;

	s.eVar10 = ShopName;
	s.events = 'event10';
	s.tl(true,'e','Online shopping mall');
	if (debugging) alert('ClickName : ' + s.eVar10 + '\nClickevents : ' + s.events);
}


var s_account ="ap-beautyangel-prd";
var s_sitename="beautyangel-kr";
/* 원본 s_code.js에 추가함 끝 */
...
//s.linkInternalFilters="javascript:,amorepacific.com,amorepacificmall.com,iope.co.kr,sulwhasoo.com.cn"
  }
function trackClicks(ClickName,Clickevents) {
  s.linkTrackVars="eVar6,hier2,events";
  s.linkTrackEvents=Clickevents;
  s.eVar6=ClickName;
  s.events=Clickevents;
  //if(s.eVar6&&!s.hier2) s.hier2=s.eVar6.replace(/\^/g,":");
  if(s.eVar6) s.hier2=s.eVar6.replace(/\^/g,":");// 2013.03.08
  s.tl(true,'o','click links');
}
...
function s_doPlugins(s) {
    ...
    /* Break up Page Name into Hireracy level */
	      if(s.pageName) {
		var valueArray = s.pageName.split("^");
		if(valueArray[0]!=undefined) {
			s.prop1=valueArray[0];		// Site
			if(valueArray[1]!=undefined) {
				s.prop2=valueArray[0]+'^'+valueArray[1];		// Category depth 1
				if(valueArray[2]!=undefined) {
					s.prop3=valueArray[0]+'^'+valueArray[1]+'^'+valueArray[2];	// Category depth 2
					if(valueArray[3]!=undefined) {
						s.prop4=valueArray[0]+'^'+valueArray[1]+'^'+valueArray[2]+'^'+valueArray[3];	// Category depth 3
						 if(valueArray[4]!=undefined) {
						   s.prop5=valueArray[0]+'^'+valueArray[1]+'^'+valueArray[2]+'^'+valueArray[3]+'^'+valueArray[4];	// Category depth 4
					}
				}
			}
		}
    ...
    /* Copy prop to eVar and Hierachy */
  if(s.prop1&&!s.eVar1) s.channel=s.eVar1="D=c1";
  ...
  if(s.pageName&&!s.hier1) s.hier1=s.pageName.replace(/\^/g,":");
  
  /* Time Parting */
	s.prop12=s.getTimeParting('h','+9','','0');
	s.prop13=s.getTimeParting('d','+9','','0');
	s.eVar12="D=c12";
	s.eVar13="D=c13";

	    /* Get referrer from parameter source*/
    if(s.getQueryParam('source')){
		
		var _uri = s.getQueryParam('source');

		if(_uri.indexOf("%3F") != -1){
			s.referrer = decodeURIComponent(_uri);
		}else{
			s.referrer = _uri;
		}
    }
  ...
  if(!s.campaign) s.campaign=s.getQueryParam('cmpid');
	s.campaign=s.getValOnce(s.campaign,'s_campaign',0);
		...
		/*MDM시 s.evar21 셋팅*/
	if(!s.eVar21) s.eVar21=s.getQueryParam('cmpmid');
		
	/* Login Count */
  if(s.eVar8) {
	if ( s.eVar8 == "로그인" || s.eVar8 == "login") s.eVar8 = "Y";
	if ( s.eVar8 == "로그아웃" ||s.eVar8 == "비로그인" || s.eVar8 == "logout") s.eVar8 = "N";
	
    var pLogin = s.getPreviousValue(s.eVar8,'s_ev8','');
    if(s.eVar8 == "Y" &&  pLogin == "N") s.events = s.apl(s.events,"event3",",",2);
    }
...
/*
 * Plugin: getQueryParam 2.4 - 2011.10
 */
...
s.visitorNamespace="amorepacific"
s.trackingServer="amorepacific.sc.omtrdc.net"
